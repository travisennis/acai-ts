...
- [ ] when calling the reset command the token tracker for the repl should reset. in fact, I think the entire token tracker should be reset to reflect a new session #feat
