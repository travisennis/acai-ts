...
export const createKnowledgeGraphTools = (options: KnowledgeGraphOptions) => {
  ...
  return {
    createEntities: tool({
      ...
      execute: async ({ entities }, { toolCallId }) => {
        sendData?.({
          id: toolCallId,
          event: "tool-init",
    ...
    createRelations: tool({
      ...
      execute: async ({ relations }, { toolCallId }) => {
        sendData?.({
          id: toolCallId,
          event: "tool-init",
    ...
    addObservations: tool({
      ...
      execute: async ({ observations }, { toolCallId }) => {
        sendData?.({
          id: toolCallId,
          event: "tool-init",
    ...
    deleteEntities: tool({
      ...
      execute: async ({ entityNames }, { toolCallId }) => {
        sendData?.({
          id: toolCallId,
          event: "tool-init",
    ...
    deleteObservations: tool({
      ...
      execute: async ({ deletions }, { toolCallId }) => {
        sendData?.({
          id: toolCallId,
          event: "tool-init",
    ...
    openNodes: tool({
      ...
      execute: async ({ names }, { toolCallId }) => {
        sendData?.({
          id: toolCallId,
          event: "tool-init",
