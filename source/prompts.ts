...
- VERY IMPORTANT: When you have completed a task that adds, edits, or removes code files, you MUST run the build tool to ensure your code is correct. If you don't change the code in any way, this is not necessary.
